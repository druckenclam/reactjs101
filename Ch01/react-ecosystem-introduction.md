...
## Summary
We have explored all the major comonents in the React ecosystem. The task of learning React seems daunting, but don't get put off. Not to worry - as the Chinese saysing goes, we will looking for a steed with the aid of its picture. We will go over all the major components of the React ecosystem and guide your step by step towards writing useful applications.
