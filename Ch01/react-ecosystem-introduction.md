...
## React 測試
Facebook has built [Test Utilities](https://facebook.github.io/react/docs/test-utils.html) into React. It is far from ideal, so most developers use Airbnb [enzyme](https://github.com/airbnb/enzyme), which works with popular testing tools such as [Mocha](https://mochajs.org/), [Karma](https://karma-runner.github.io/) and Jest. [Jest](https://facebook.github.io/jest/) is a unit testing tool by Facebook. It is based on [Jasmine](http://jasmine.github.io/). Jest supports JSDOM, and mocks packages loaded by `require()`, allowing developers to place more focus on modules under test.

## React Native
[React Native](https://facebook.github.io/react-native/), different from past webview solution such as [Apache Cordova](https://cordova.apache.org/), allows developer to develop native applications using React and Javascript, making `Learn once, write anywhere` a real possibility.
